...
export default function HRDocumentsPage() {
  ...
  const [form, setForm] = useState({ employee_id: '', document_type: 'omang', title: '', issue_date: '', expiry_date: '', notes: '', file: null });
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col lg:flex-row text-slate-900">
      ...
      <ConfirmDialog
        ...
        message={deleteTarget ? `Delete ${deleteTarget.file_name}? The stored file will also be removed. This action cannot be undone.` : ''}
