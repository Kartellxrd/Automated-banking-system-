...
import { Banknote, Building2, Calculator, ChevronRight, CreditCard, FileCheck2, Landmark, LogOut, Menu, Receipt, UserCheck, X } from 'lucide-react';
...
export default function AccSideNav() {
  ...
  const navItems = [
    ...
    { name: 'Payment Setup', href: '/dashboard/accountant/payment-setup', icon: Landmark },
