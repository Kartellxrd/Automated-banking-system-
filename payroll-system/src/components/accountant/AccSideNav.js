...
import { Building2, Calculator, ChevronRight, FileCheck2, LogOut, Menu, Receipt, X } from 'lucide-react';
...
export default function AccSideNav() {
  ...
  const navItems = [
    ...
    { name: 'Expenses', href: '/dashboard/accountant/expenses', icon: Receipt },
  ];
